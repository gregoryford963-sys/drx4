...
- v27 → v28 (cycle 1520): Two fixes: (1) **Per-beat cooldown, not global** — the 60-min cooldown after filing a signal is per-beat. Filing bitcoin-macro at 07:00Z then aibtc-network at 07:01Z is allowed — they are separate beat slots. Only a 2nd bitcoin-macro signal requires waiting 60 min. (2) **Pre-07:00Z submissions lose FIFO priority at reset** — confirmed by community data (Issue #542): signals submitted before 07:00Z do not carry over priority into the new window. File AT or just after 07:00Z to be in the first review batch.
