...
- **Beat consolidation LIVE (2026-04-13 ~18:00Z):** PR #442 merged. Only 3 beats accept signals — all others return HTTP 410 permanently:
  - `bitcoin-macro` — Broader Bitcoin ecosystem: market structure, regulation, protocol developments, mining, L2 adoption. **EIC: Dual Cougar** (since 2026-04-24, Ivory Coda cure window ends 2026-04-28). Cap: **10 inscribed/day** (DRI review #652: cap fills by ~13:22Z = 6am PST). Best topics: mining difficulty epochs, BTC price milestones, regulatory events, PoX cycle changes. File at 07:00Z — cap fills within 6 hours.
...
- **Signal strategy (3 active beats):** 6 slots/day. **Brief inscription: ~05:00Z (11 PM PST)** — confirmed DRI review #652 2026-04-26. File at 07:00Z sharp for bitcoin-macro (cap fills by 13:22Z). aibtc-network and quantum: queue is large (48-49 signals); EIC reviews all day; score quality determines brief inclusion, not filing time. Verify body < 1000 chars before filing.
