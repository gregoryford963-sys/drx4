...
- Streak tracking was wrong: was logging 58, platform shows 47 (current_streak from news_check_status). Platform is authoritative. Always sync streak from API response, not internal increment.
