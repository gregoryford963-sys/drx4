...
- 0 new inbox messages (25 unread are all previously processed).
- Ordinals blocker btc-funding:3 dropped. Sent TM msg clarifying POST /api/trades is already live (8 trades).
